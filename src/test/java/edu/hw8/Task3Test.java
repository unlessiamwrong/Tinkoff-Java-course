...
public class Task3Test {
    ...
    private final Map<String, String> dataBase = Map.of(
        "a.v.petrov",
        "83cd3d8fb5b3ca7ca9af183096ef124a",
        "v.v.belov",
        "8030e98debc079fafb8c5de8efb1d0ed",
        "a.s.ivanov",
        "b2a2b5165c591698f26a403060f6ca9e",
        "k.p.maslov",
        "60d6f2142fc537d7c2c7b11c1b23a48f"
    );

    @Test void hack_St_ReturnsNotNull_Test() {
        //Arrange
    ...
    @Test void hack_Mt_ReturnsNotNull_Test() throws InterruptedException {
        //Arrange
